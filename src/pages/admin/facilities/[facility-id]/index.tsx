...
export default function FacilityDetail() {
  ...
  return (
    <AdminDashboard isFacility title={facility?.name || 'Thiết bị'}>
      {isError ? (
        <Empty title='Không tìm thấy thiết bị' />
      ) : (
        <>
          ...
          <Box pl='5' pb='5'>
            ...
            <Box>
              ...
              <Grid templateColumns='repeat(2, 1fr)' gap={9} pl='5' pt='5'>
                <GridItem colSpan={1}>
                  <Grid templateColumns='repeat(4, 1fr)' gap={4}>
                    <GridItem colSpan={1}>
                      <Text textStyle='bold-sm'>Tên thiết bị:</Text>
                    </GridItem>
                    <GridItem colSpan={3}>
                      <Text>{facility?.name}</Text>
                    </GridItem>
                    <GridItem colSpan={1}>
                      <Text textStyle='bold-sm'>Giá trị:</Text>
                    </GridItem>
                    <GridItem colSpan={3}>
                ...
                <GridItem colSpan={1}>
                  <Grid templateColumns='repeat(4, 1fr)' gap={4}>
                    <GridItem colSpan={1}>
                      <Text textStyle='bold-sm'>Nguồn gốc:</Text>
                    </GridItem>
                    <GridItem colSpan={3}>
              ...
              <Text textStyle='bold-md'>Thông tin chi tiết</Text>
